    ...
    private class InternalRecognitionListener implements RecognitionListener {
        ...
        public void onError(final int error) {
            if (error == SpeechRecognizer.ERROR_NO_MATCH) {
                ...
                //TODO: Added logic to restart recogiition if no match error but we need to add logic here
                // to stop this after x number of tries
                restartRecognition();
                return;
            }
        ...
        public void onResults(final Bundle results) {
            ...
            if (recognitionActive) {
                ...
                if (recognitionResults == null || recognitionResults.isEmpty()) {
                    ...
                    //TODO:bypassing the rates logic by hardcoding false in if logic.
                    //TODO: Changing this so that we only send first result as api.ai is picking the second result
                    //for example if you say hi, ouf of following values 9(hi, high, height, hai), high is being picked.
                    if (rates != null && false) {
