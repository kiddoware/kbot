...
class Eula {
    ...
    static boolean showEULA(final Activity activity) {
        ...
        if (!preferences.getBoolean(PREFERENCE_EULA_ACCEPTED, false)) {
            ...
            builder.setTitle(com.kiddoware.kbot.R.string.eula_title);
            builder.setCancelable(true);
            builder.setPositiveButton(com.kiddoware.kbot.R.string.eula_accept, new DialogInterface.OnClickListener() {
            ...
            builder.setNegativeButton(com.kiddoware.kbot.R.string.eula_refuse, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    refuse(activity);
                }
            });
